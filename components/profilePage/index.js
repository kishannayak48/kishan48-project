        ...
        <div className="main-body">
          <div className="row">
            <div className="col-lg-4">
              <div className="card bg-body shadow border-0 shadow">
                <div className="card-body">
                  <div className="d-flex flex-column align-items-center text-center">
                    ...
                    <div className="mt-3">
                      <h4>Avinash</h4>
                      <p className="text-secondary mb-1">Project Manager</p>
                      <p className="text-muted font-size-sm">
                        Race Cross Road, Indore.
                      </p>
            ...
            <div className="col-lg-8">
              <div className="card border-0 shadow bg-body mb-2">
